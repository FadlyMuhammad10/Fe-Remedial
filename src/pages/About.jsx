        ...
        <section id="about" className="about">
            <div className="container-fluid d-flex justify-content-center">
                ...
                <div className="col-10 col-lg-11">
                    <div className="row justify-content-center">
                        <div
                            className="col-xl-5 col-lg-6 img-box d-flex justify-content-center align-items-stretch position-relative">
                                    ...
                                    <div className="member-info">
                                        ...
                                        <div className="social">
                                            ...
                                            <a href="https://instagram.com/chika.aul?igshid=YmMyMTA2M2Y="
                                                target="blank"><i className="bi bi-instagram"></i></a>
                                ...
                                <div className="member">
                                    ...
                                    <div className="member-info">
                                        ...
                                        <div className="social">
                                            ...
                                            " target="_blank"><i className="bi bi-facebook" target="_blank"></i></a>
                                ...
                                <div className="member">
                                    ...
                                    <div className="member-info">
                                        ...
                                        <div className="social">
                                            ...
                                            <a href="https://instagram.com/aaannnnwar?igshid=MzNlNGNkZWQ4Mg==" target="_blank"><i
                                                    className="bi bi-instagram"></i></a>
