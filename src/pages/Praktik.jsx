            ...
            <div className="col-11 col-xl-10">
              ...
              <div className="row justify-content-center">
                <div className="col-12 col-sm-12 col-md-8 col-lg-8">
                  ...
                  <h1 className="mt-3">
                    <strong>
                      Teknik Kolase Teori, Praktik & Pertimbangan Juxtaposition
                    </strong>
                  </h1>
                  <p>
                    Teknik kolase adalah penyusunan komposisi karya seni rupa
                    yang dilakukan dengan cara menempelkan berbagai bahan
                    seperti kain perca, bulu, potongan koran, dan bahan lainnya
                    pada media karya. Teknik ini terdengar biasa saja dan malah
                    tampaknya hanya cocok untuk hobi sehari-hari, bukan karya
                    seni. Lalu, sebetulnya apa faktor yang menyebabkan
                    keberhasilan dari teknik kolase sehingga mampu mewakili
