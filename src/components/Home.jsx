                 ...
                 <div className="carousel-container">
                     <div className="container">
                         ...
                         <p className="animated fadeInUp">
                             ...
                             1 tahun di 2019. Kegiatan ini melibatkan murid SMA (pilihan)
                             di Jakarta dan sekitarnya yang berfokus pada pola konsumsi
                             informasi dan pengetahuan berdasarkan perkembangan hari ini.
                             Dengan metode saling silang informasi yang menghasilkan
                             pengetahuan dan pendekatan seni dan literasi.
                         </p>
                     </div>
                 </div>
             </div>
  ...
  <section id="about" className="about">
         <div className="container-fluid pt-5">
             <div className="row justify-content-center">
                 <div
                     className="col-10 col-sm-10 col-md-9 col-lg-5 col-xl-5 img-box d-flex justify-content-center align-items-stretch position-relative">
                     {/*<a href="" className="glightbox play-btn mb-4"></a> */}
                 </div>

                 <div
                     className="col-10 col-sm-10 col-md-11 col-lg-5 col-xl-5 icon-boxes d-flex flex-column align-items-stretch justify-content-center py-5 px-lg-5">
                     <h6>
                     ...
                     <div className="row">
                         <div className="col-lg-6">
                             ...
                             <div className="seni-item mt-4">
                                 ...
                                 <h3>
                                     <a href="#!">
                                         Tari: Pengertian, Unsur-Unsur, Fungsi, dan Jenis.
                                     </a>
                                 </h3>
                                 <div className="entry-meta">
                                     {/* <time className="entry-date published updated"
                         ...
                         <div className="col-lg-6 mt-lg-0 mt-md-5 mt-sm-5 mt-5">
                             ...
                             <div className="seni-item mt-4">
                                 ...
                                 <h3>
                                     <a href="#!">
                                         {" "}
                                         Musik Tradisional Beserta Alat Musiknya
                                     </a>
                                 </h3>
                                 <div className="entry-meta">
                                     {/* <time className="entry-date published updated"
                                 ...
                                 <ul id="package-productReviews">
                                     <li>
                                         <div className="package-preview-icon">
                                             <picture>
                                                 <img src="https://imgix3.ruangguru.com/assets/payment/payment_flow/landing_page/review-star.png"
                                                     width="20" alt="" />
                                             </picture>
                                         </div>
                                         <p>
                                     ...
                                     <li>
                                         <div className="package-preview-icon">
                                             <picture>
                                                 <img src="https://imgix3.ruangguru.com/assets/payment/payment_flow/landing_page/review-light.png"
                                                     width="20" alt="" />
                                             </picture>
                                         </div>
                     ...
                     <div className="col-sm-7 col-md-6 col-lg-5 col-xl-6 h-100 d-flex justify-content-center">
                         <div className="package-card">
                             ...
                             <div className="package-card-bottom">
                                 ...
                                 <a href="program.html" className="btn-package"
                 ...
                 <div className="col-10 col-sm-10 col-md-10 col-lg-11 col-xl-10">
                     <div className="row">
                         ...
                         <div className="col-lg-4 col-md-6 icon-box">
                             ...
                             <h4 className="title">
                                 <a href="https://youtube.com/playlist?list=PLhkyWqKxYl7LChI6lcooI-7_f_zFpo6Jh"
                                     target="_blank">
                                     Seni Tari
                                 </a>
                             </h4>
                         ...
                         <div className="col-lg-4 col-md-6 icon-box">
                             ...
                             <h4 className="title">
                                 <a href="https://youtube.com/playlist?list=PLhkyWqKxYl7Jygbz5eF4sU7vvkRfY5ikO"
                                     target="_blank">
                                     Seni Rupa
                                 </a>
                             </h4>
                         ...
                         <div className="col-lg-4 col-md-6 icon-box">
                             ...
                             <h4 className="title">
                                 <a href="https://youtube.com/playlist?list=PLHsx37V5nkBokmu8UWeBH51cD6jMT7OMc"
                                     target="_blank">
                                     Seni Musik
                                 </a>
                             </h4>
                         ...
                         <div className="col-lg-4 col-md-6 icon-box">
                             ...
                             <h4 className="title">
                                 <a href="https://youtube.com/playlist?list=PLhkyWqKxYl7L8YaQ0VDaOgU9S769nj1Ff"
                                     target="_blank">
                                     Seni Teater
                                 </a>
                             </h4>
                     ...
                     <div className="row">
                         <div className="col-lg-6">
                             ...
                             <div className="seni-item">
                                 ...
                                 <h3>
                                     <a href="#!">
                                         {" "}
                                         Sastra: Pengertian & Berbagai Pendekatannya
                                     </a>
                                 </h3>
                                 <div className="entry-meta">
                                     {/* <time className="entry-date published updated"
                         ...
                         <div className="col-lg-6 mt-lg-0 mt-md-5 mt-sm-5 mt-5">
                             ...
                             <div className="seni-item mt-4">
                                 ...
                                 <h3>
                                     <a href="#!">
                                         Pengertian, Sistematika, Kaidah & Contoh
                                     </a>
                                 </h3>
                                 <div className="entry-meta">
                                     {/* <time className="entry-date published updated"
